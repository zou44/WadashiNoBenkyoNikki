...
| 被动 | to be done | to be doing | to have been done |

#### 基本用法
1. 作主语
`To finish the work in ten minutes` is very hard. - 十分钟内完成这项工作是非常困难的. (主系表结构, 主语为动词不定式短语)  
It is very hard `to finish the work in ten minutes`. - 十分钟内完成这项工作是非常困难的. (主系表结构, 主语为不定式短语)  
`To see` is to believe. - 眼见为实. (To see 作主语)  
`注意:动词不定式作主语时, 常用it作形式主语, 真正的主语(不定式短语)置于句末.`
2.  作表语  
...
5.  作定语
`动词不定式作定语时, 放在它所修饰的名词或代词后.`  
I have a meeting `to attend`. - 我有一个会议要参数. (to attend修饰宾语meeting)
6.  作状语  
...
#### 注意
1.  除了`分词不能作主语和宾语外`, `四种非谓语动词均能做句中所有成分`.
2.  当宾补不带to时, 一般用的是过去分词表动作已完成. 当然也可以使用现在分词,表示动作正在进行中.


### 动名词
动名词具有`名词的性质`, 在句中可充当所有成分.
...
1.  作主语
    ...
    -   It is/was `a waste of time`(浪费时间) doing sth.  
    `It's no use quarreling. - 争吵是没有用的.`
2.  作表语
    Life is `painting` a picture, not `doing` a sum. - 生活是绘画, 不是做算术.
3.  宾语
    -   (1) 常见用法
        Did she mind `paying` the taxi driver? - 她介意给出租车司机付钱吗
    -   (2) 某些固定短语中要用动名词作宾语:get down no(开始做...), feel like(想要...), insist on(坚持...), succeed in(做...很成功)等.
        I have caught a cold and I don't `feel like` eating anything. - 我感觉了, 不想吃任何东西.
    -   (3) 介词后需要非谓语动词作宾语, 要用动名词形式.
        We can't help crying after `hearing` the sad news. - 听到这个不幸的消息后我开始哭泣.
#### 否定形式
否定形式是在动名词前直接加not.  
